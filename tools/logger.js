...
/*
    Why winston?
    Because when we run on multiple servers, checking logs by ssh one by one is a PITA
    With winston we can use dedicated log server like ELK stack or use service like Loggly
*/
